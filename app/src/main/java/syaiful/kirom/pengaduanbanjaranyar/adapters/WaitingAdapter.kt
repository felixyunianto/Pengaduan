...
class WaitingAdapter(private var data : List<Aduan>, private var context : Context) : RecyclerView.Adapter<WaitingAdapter.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(
            LayoutInflater.from(context).inflate(R.layout.list_item_aduan, parent, false)
        )
    }
